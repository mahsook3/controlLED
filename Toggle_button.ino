...
#define FIREBASE_HOST "toggle-button-9fc98-default-rtdb.firebaseio.com" // change here
#define FIREBASE_AUTH "nwWrAnV7G7dAPyS9KPAtsOw6JDBedXYeDNHtNkKZ"  // your private key
